...
import com.example.juicetracker.data.JuiceColor // Pastikan ini diimport
...
// Memindahkan fungsi ini ke dalam SheetForm agar bisa diakses
private fun findColorIndex(color: String): Int {
    return JuiceColor.values().indexOfFirst { it.name == color }
}
